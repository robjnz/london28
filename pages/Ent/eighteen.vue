...
<section main>
  ...
  <h1 class="title-color">2018 Movies free to watch online </h1>
  <b-button-group>
    <eighteenB />
    <nineteenB />
  </b-button-group>
...
export default {
  head () {
    return {
      titleTemplate: '%s 2018 Free-Movies',
      meta         : [
        { hid: 'description', name: 'description', content: 'movies made in 2018 free to watch online' }
      ]
    }
  },
  components: {
